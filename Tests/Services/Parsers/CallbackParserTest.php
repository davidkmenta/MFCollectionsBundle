...
namespace MFCollectionsBundle\Tests\Services\Parsers;
...
class CallbackParserTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->callbackParser->parseArrayFunc($func);
    }
    ...
    {
        $callback = $this->callbackParser->parseArrayFunc($function);
    ...
    public function testShouldReturnCallableCallbackRightAway()
    {
        ...
        $callback = $this->callbackParser->parseArrayFunc($callable);
